...
# Simple C++ performance test
cat > test/perf/perf_test.cpp << 'EOF'
#include <chrono>
#include <iostream>
...
# Compile the test
cd /data/data/com.termux/files/home/libcamera1
c++ -Ibuild/include -Lbuild/src/libcamera -Lbuild/src/libcamera/base -l:libcamera.so -l:libcamera-base.so -std=c++17 test/perf/perf_test.cpp -o test/perf/perf_test -lpthread